...
We included our toy data set with the package for the users to work with. The function loadWineData.R accesses the included dataset. loadWineInfo loads more info on the dataset, such as labels for the variables and wines. See the plotting part of vignette for example of loading the data and including the labels in your plots.
...
----
Upon running MFA::runExample(), the shiny app should pop up with the compromise (i.e. common factor score) plot displayed. You can change which components to use as the x and y axes with the numeric input boxes labeled "X,Y-axis Dimension".

<center>![Visualization of Factor Scores](images/wine-compromise-25-percent.png)</center>

----
You can click 'Partial Factor Scores' to see the partial factor scores, and you can change the dimensions of the axes as well as the table (assessor) number with the numeric input boxes for dimensions and table.

<center>![Partial factor scores of table 1, dimension 1 and 2](images/wine-partial-25-percent.png)</center>

----
You can select 'Variable Loadings' to see where the variables lie for each table, in different dimensions. Below is the loading for table 3, with axes corresponding to the first 2 components.

<center>![Variable loadings for table 3, dimension 1 and 2](images/wine-loading-tab3-25-percent.png)</center>

----
Click 'Eigenvalue Bar Plot' to see this visualization:
...
<center>![Percentage of inertia of the eigenvalues](images/wine-pie-25-percent.png)</center>
