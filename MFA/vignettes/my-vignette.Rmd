...
----
Upon running MFA::runExample(), the app should pop up with the compromise plot displayed:

<center>![Visualization of Factor Scores](images/1.png)</center>

----
You can click 'Partial Factor Scores' to see the partial factor scores, and you can change the dimensions of the axes as well as the table (assessor) number with the numeric input boxes. For example, here is a plot of assessor 4, dimensions 2 and 6.

<center>![Partial factor scores of table 4, dimension 2 and 6](images/2.png)</center>

----
You can select 'Variable loadings' to see where the variables lie.
...
----
Select Inertia pie chart to see this:

<center>![Percentage of inertia of the eigenvalues](images/5.png)</center>
