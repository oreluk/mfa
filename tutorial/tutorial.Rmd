...
- $M = \text{diag}(m)$,  $M \in \mathbb{R}^{n \times n}$
    ...
    + For equal weighting across the observations, $m_i =\frac{1}{I}$ where $I = \text{numObs}$ (number of observations)
...
## Each of these should be a slide on its own...

## What can you do?
- Enables a simple way to complete a multiple factor analysis
- Provides various ways to visualize the factor analysis through bi-plots
- auxilary functions (Rv/lg) 
...
- code goes here
- return all properties of the function
