...
```
- `dsWine` is a mfa object with a completed mulitple factor analysis
...
- where the following optional inputs are: 
    + ncomps: the number of components returned in the analysis
    + center: centering of each of the sets utilizing the R base function `scale()` 
    + scale: scales each of the sets by utilizing the R base function `scale()`


## View results 

Looking at the singular values and eigenvalue table:
...
- show some functions or properties of the object: loading, factor scores...rv/lg, plotting
- ...
