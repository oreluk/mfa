...
## Features
-MFA constructor: mfa.R

-Print method: print-mfa.R

-Six plotting methods: plot_compromise.R, plot_ev.R, plot_loading.R, plot_biplot.R, plot_partial_fac.R, plot_inertia_pie.R

-Additional descriptive statistics: lg.R, lg_table.R, rv.R, rv_table.R, obs_dim.R, var_dim.R, table_dim.R, bootstrap_factorscores.R

-A toy data set to experiment with: loadWineData.R

-A Shiny App: runExample.R
